---
# TEMPLATE: copy this file to _posts/YYYY-MM-DD-your-title.md and edit.
# Files in _drafts/ are never published, so this one is safe to keep here.
...
# image:
#   path: /assets/img/your-cover.png
...
<!-- Images: save the file in assets/img/ (resize it first), then:
![Alt text](/assets/img/your-image.png){: w="700" }
_Caption text_
-->

> A highlighted note. Other types: `prompt-info`, `prompt-warning`, `prompt-danger`.
{: .prompt-tip }
